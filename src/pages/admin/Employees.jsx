              ...
              <div className="p-4 border-b border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3">
                <div className="relative flex-1 w-full">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-1.5 border border-slate-200 rounded text-xs text-slate-700 focus:outline-none focus:border-[#00897b] transition-colors"
                  />
                </div>
                    ...
                    {loading ? (
                      <tr>
                        <td colSpan={4} className="py-8 text-center text-slate-400 text-xs">
                          <Loader2 className="w-5 h-5 animate-spin mx-auto mb-2 text-[#00897b]" />
              ...
              <div className="p-4 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 gap-3 bg-white">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <select
                    ...
                    className="border border-slate-200 rounded px-2 py-1 bg-white text-xs text-slate-700 font-medium focus:outline-none focus:border-[#00897b]"
                  >
        ...
        {currentView === 'create' && (
          <>
            <div className="text-xs text-slate-500 mb-4">
              ...
              <ChevronRight className="w-3 h-3 inline mx-1 text-slate-400" />
              <span className="text-[#00897b] font-medium">Novo Cadastro</span>
            </div>
            ...
            <form onSubmit={handleOpenModal} className="bg-white rounded-lg shadow-sm border border-slate-200/80 overflow-hidden">
              <div className="p-6 border-b border-slate-100">
                <div className="flex items-center space-x-2 mb-6">
                  <div className="w-6 h-6 rounded-full bg-[#00897b]/10 text-[#00897b] font-bold text-xs flex items-center justify-center">1</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full border border-slate-200 rounded px-3 py-2 text-xs focus:outline-none focus:border-[#00897b]"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full border border-slate-200 rounded px-3 py-2 text-xs bg-white focus:outline-none focus:border-[#00897b]"
                    >
              ...
              <div className="p-4 bg-slate-50 border-t border-slate-100 flex justify-end">
                <button type="submit" className="bg-[#00897b] hover:bg-[#00796b] text-white font-semibold px-6 py-2 rounded text-xs transition-colors">
                  Continuar
                </button>
              </div>
            </form>
        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-2xl max-w-md w-full border border-slate-200">
            ...
            <div className="p-4 border-t border-slate-100 flex justify-end space-x-2 bg-slate-50/50">
              ...
              <button onClick={handleConfirmCreate} className="bg-[#00897b] text-white px-5 py-1.5 rounded text-xs">Salvar no Banco</button>
            </div>
          </div>
        </div>
      )}
